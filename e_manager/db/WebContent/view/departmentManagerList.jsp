	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'sn',title:'负责人编号',width:200, sortable: true},    
 		        {field:'name',title:'姓名',width:200},
 		        {field:'password',title:'密码',width:200},
 		        {field:'sex',title:'部门名称',width:100},
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "确定删除宿管信息吗？(该宿管信息下所属的楼宇信息须先删掉，否则会删除不成功！)", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin-left: 10px;margin-top: 5px;">姓名：<input id="search-name" class="easyui-textbox" name="name" /></div>
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>部门名称:</td>
	    			<td><select id="add_sex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="sex"><option value="学校">学校</option><option value="教育局">教育局</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
	...
	<div id="editDialog" style="padding: 10px">
		<form id="editForm" method="post">
	    	...
	    	<input type="hidden" id="edit-sn" name="sn" />
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>姓名:</td>
	    		...
	    		<tr>
	    			<td>部门名称:</td>
	    			<td><select id="edit_sex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="sex"><option value="计算机">学校</option><option value="数统学院">教育局</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
