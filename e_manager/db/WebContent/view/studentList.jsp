	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'sex',title:'疫情状况',width:100},
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
	    	...
	    	buttons: [
				...
				},
				{
					...
					handler:function(){
						...
						$("#edit_sex").combobox('setValue', "yes");
					}
				}
			],
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>疫情状况:</td>
	    			<td><select id="add_sex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="sex"><option value="yes">yes</option><option value="not">not</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
	...
	<div id="editDialog" style="padding: 10px">
		<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>疫情状况:</td>
	    			<td><select id="edit_sex" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="sex"><option value="yes">yes</option><option value="not">not</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
