...
<head>
    ...
    <title>西北师范大学疫情防控系统 管理员后台</title>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"2","icon":"","menuname":"部门管理",
							"menus":[
									{"menuid":"21","menuname":"部门列表","icon":"icon-user-teacher","url":"DormitoryManagerServlet?method=toDormitoryManagerListView"},
								]
						},
						{"menuid":"3","icon":"","menuname":"学院管理",
							"menus":[
									{"menuid":"31","menuname":"学院列表","icon":"icon-house","url":"BuildingServlet?method=toBuildingListView"},
								]
						},
						</c:if>
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">西北师范大学疫情防控系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; By 【ppx】</div>
    </div>
